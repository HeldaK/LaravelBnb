            ...
            <div :class="[{'col-md-8':twoColumns}, {'col-md-12' : oneColumn}]">
                ...
                <div v-else>
                    <div v-if="alreadyReviewd">
                        <h3>You've alraedy left a review for this booking</h3>
                    </div>
                    <div v-else>
                        <div class="form-group">
                            <label class="text-muted">Select the star rating (1 ist worst - 5 ist best)</label>
                            <star-rating :rating="review.rating" class="fa-3x text-warning" v-model="review.rating"></star-rating>
                        </div>
                        <div class="form-group">
...
export default {
  components: { Success },
    ...
    async created() {
        ...
        this.loading = true;
        //1. If review exists(in review table by id)
        try{
